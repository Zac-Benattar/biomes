...
export class CharacterControls {
  ...
  public update(delta: number, keysPressed: any) {
    ...
    if (this.currentAction !== play) {
      ...
      if (!toPlay || !current) {
        console.error("Animation not found for action:", play, " or ", current);
        return;
      }
    ...
    if (this.currentAction == Action.Run || this.currentAction == Action.Walk) {
      ...
      // run/walk velocity
      const velocity =
        this.currentAction == Action.Run ? this.runSpeed : this.walkSpeed;
